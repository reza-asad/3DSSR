...
def get_args():
    ...
    parser.add_argument('--mesh_dir_output', default='../data/{}/pc_rooms')
    parser.add_argument('--seed', default=0, type=int, help='use different seed for parallel runs')
    parser.add_argument('--scene_coverage', default=0.3, type=int, help='used for finding numebr of points')
