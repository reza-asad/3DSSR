...
class Region(Dataset):
    def __init__(self, pc_dir, scene_dir, metadata_path, mode, transforms=None, cat_to_idx=None, file_name_to_idx=None,
    ...
    def __getitem__(self, idx):
        ...
        # prepare file_name
        file_names = torch.zeros((1, 1))
        file_names[0, 0] = self.file_name_to_idx[self.file_names[idx]]
