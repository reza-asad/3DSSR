...
def make_args_parser():
    ...
    parser.add_argument("--loss_rot_mat_weight", default=5.0, type=float)
    ...
    parser.add_argument("--alignment_model_ckpt", default=None, type=str)
...
def main(local_rank, args):
    ...
    alignment_model = torch.load(args.alignment_model_ckpt, map_location=torch.device("cpu"))
    model_no_ddp.alignment_model.load_state_dict(alignment_model["model"])
    model_no_ddp.alignment_model.eval()
    for p in model_no_ddp.alignment_model.parameters():
