...
# TODO: the equivariant version of the transformer encoder
class TransformerEncoderEquiv(nn.Module):
...
# TODO: equivariant version of transformer encoder layer.
class TransformerEncoderLayerEquiv(nn.Module):
